public class Dcs.UI.PolarHeatMap : GLib.Object, Dcs.Object, Dcs.Container,
    ...
    private Dcs.UI.PolarHeatMap.Data data;
    ...
    private struct Cell {
        ...
        public Dcs.TriplePoint point;      // the 2D coordinates and magnitude
    ...
    private class Data : Gee.LinkedList<Dcs.UI.PolarHeatMap.Cell?> {
        ...
        public Dcs.TriplePoint [,] points {
            get {
                _points = new Dcs.TriplePoint[rings, sectors];
    ...
    construct {
        ...
        data = new Dcs.UI.PolarHeatMap.Data ();
    }
        ...
        for (int i = 0; i < data.size; i++) {
            ...
            switch (gradient) {
                case Dcs.UI.ColorGradientType.RGB:
                    cell.color =  Dcs.UI.rgb_lerp (value,
                                                    min_color, 0, max_color, 1);
                    break;
                case Dcs.UI.ColorGradientType.HSV:
                    cell.color =  Dcs.UI.hsv_lerp (value,
                                                    min_color, 0, max_color, 1);
                    break;
                default:
                    break;
 ...
 */
        ...
        for (int i = 0; i < data.size; i++) {
            var cell = data.get (i);
            var sweep = Dcs.UI.degrees_to_radians (data.cell_sweep);
    ...
    public void draw (Cairo.Context cr) {
        var stencil = new Dcs.UI.PolarHeatMapView (image_surface);
