...
namespace Dcs.UI {
    ...
    public Type? type_from_name (string name) {
        ...
        switch (simplified) {
			case "aicontrol":
				type = typeof (Dcs.UI.AIControl);
				break;
            case "aocontrol":
                type = typeof (Dcs.UI.AOControl);
                break;
			case "box":
				type = typeof (Dcs.UI.Box);
				break;
            case "channeltreeview":
                type = typeof (Dcs.UI.ChannelTreeView);
                break;
            case "page":
                type = typeof (Dcs.UI.Page);
                break;
            case "richcontent":
                type = typeof (Dcs.UI.RichContent);
                break;
            case "window":
                type = typeof (Dcs.UI.Window);
                break;
            default:
                break;
        }
