...
public class Dcs.UI.ChartWidget : Gtk.Box {
    ...
    public ChartWidget () {
        ...
        chart_area = new Dcs.UI.ChartArea ();
        x_axis_area = new Dcs.UI.XAxisArea ();
        y_axis_area = new Dcs.UI.YAxisArea ();
    ...
    public virtual void add_series (string id) {
        (chart_area as Dcs.UI.ChartArea).data_series.set (id, new Gee.ArrayList<Dcs.Point> ());
    }

    public virtual void add_series_with_data (string id, Gee.List<Dcs.Point> data) {
        (chart_area as Dcs.UI.ChartArea).data_series.set (id, data);
    }

    public virtual void add_point_to_series (string id, double x, double y) {
        var list = (chart_area as Dcs.UI.ChartArea).data_series.get (id);
        list.add (new Dcs.Point (x, y));
    }

    public virtual void add_series_color (Gee.List<double?> color) {
        (chart_area as Dcs.UI.ChartArea).series_colors.add (color);
    }

    public virtual void select_series (string series_id) {
        (chart_area as Dcs.UI.ChartArea).selected_series = series_id;
    }
}

public class Dcs.UI.StripChartWidget : Dcs.UI.ChartWidget {
    ...
    public override void add_point_to_series (string id, double x, double y) {
        ...
        if (!(chart_area as Dcs.UI.ChartArea).data_series.has_key (id))
            return;
...
public class Dcs.UI.XAxisArea : Gtk.DrawingArea {
...
public class Dcs.UI.YAxisArea : Gtk.DrawingArea {
...
public class Dcs.UI.ChartArea : Gtk.DrawingArea {
    ...
    public Gee.Map<string, Gee.List<Dcs.Point>> data_series;
    ...
    construct {
        data_series = new Gee.TreeMap<string, Gee.List<Dcs.Point>> ();
    ...
    public override bool draw (Cairo.Context cr) {
        ...
        foreach (var key in data_series.keys) {
            ...
            Gee.List<Point> subset = new Gee.ArrayList<Dcs.Point> ();
    ...
    private void draw_line (Cairo.Context cr, Gee.List<Dcs.Point> data) {
        var w = get_allocated_width ();
        var h = get_allocated_height ();
    ...
    private void draw_polyline (Cairo.Context cr, Gee.List<Dcs.Point> data) {
        var w = get_allocated_width ();
        var h = get_allocated_height ();
        int i;
