 ...
 */
public interface Dcs.UI.Drawable : GLib.Object {
 ...
 */
[Compact]
private class Dcs.UI.StripChartGrid : Cairo.Context {

    public StripChartGrid (Cairo.Surface target) {
        base (target);
    }

    public void draw (Dcs.UI.Axis x_axis, Dcs.UI.Axis y_axis, Gdk.RGBA color, int w, int h) {
...
[Compact]
private class Dcs.UI.ChartGrid : Cairo.Context {
...
[Compact]
public class Dcs.UI.PolarChartGrid : Cairo.Context {
    ...
    public void limits (Dcs.UI.PolarAxis mag_axis,
                                     Dcs.UI.PolarAxis angle_axis, int w, int h,
        ...
        var t1 = Dcs.UI.degrees_to_radians (angle_axis.min);
        var t2 = Dcs.UI.degrees_to_radians (angle_axis.max);
    ...
    public void draw (Dcs.UI.PolarAxis mag_axis, Dcs.UI.PolarAxis angle_axis,
...
[Compact]
private class Dcs.UI.Line : Cairo.Context {

    public Line (Cairo.Surface target) {
        base (target);
    }

    public void draw (Dcs.Point[] data) {
...
[Compact]
private class Dcs.UI.Polyline : Cairo.Context {
...
[Compact]
private class Dcs.UI.Scatter : Cairo.Context {
...
[Compact]
private class Dcs.UI.Bar : Cairo.Context {

    public Bar (Cairo.Surface target) {
        base (target);
    }

    public void draw (Dcs.Point[] data, Dcs.Point origin, bool outline = false) {
        var x = origin.x + 1.0;
        for (var i = 0; i < data.length - 1; i++) {
...
[Compact]
private class Dcs.UI.Ring : Cairo.Context {
...
[Compact]
private class Dcs.UI.Vector : Cairo.Context {
...
[Compact]
private class Dcs.UI.VectorField : Cairo.Context {
...
[Compact]
private class Dcs.UI.HeatMapView : Cairo.Context {
...
[Compact]
private class Dcs.UI.PolarHeatMapView : Cairo.Context {
    ...
    public void draw (Gdk.RGBA[,] colors,
                                  Dcs.UI.PolarHeatMap.AnnulusSector[,] sectors) {
...
[Compact]
private class Dcs.UI.AxisView : Cairo.Context {

    public AxisView (Cairo.Surface target) {
        base (target);
    }

    public void draw (int w, int h, Dcs.UI.Axis axis) {
        ...
        if (orientation == Dcs.UI.Orientation.HORIZONTAL) {
            for (var i = 0; i <= div_major; i++) {
                ...
                if (axis.flags.is_set (Dcs.UI.AxisFlag.DRAW_MAJOR_TICKS)) {
                    this.move_to (x, y);
            ...
            /* Draw minor ticks */
            if (axis.flags.is_set (Dcs.UI.AxisFlag.DRAW_MINOR_TICKS)) {
