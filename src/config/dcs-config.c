...
const char *DCS_NAME = PACKAGE_NAME;
const char *DCS_STRING = PACKAGE_STRING;
const char *DCS_CONFDIR = PACKAGE_CONFDIR;
...
const char *DCS_TEMPLATE_DIR = TEMPLATE_DIR;
const char *DCS_WEB_EXTENSION_DIR = WEB_EXTENSION_DIR;
