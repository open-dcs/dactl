...
public enum Dcs.UI.AxisFlag {
    ...
    public Dcs.UI.AxisFlag set (Dcs.UI.AxisFlag flag) {
        return (this | flag);
    }

    public Dcs.UI.AxisFlag unset (Dcs.UI.AxisFlag flag) {
        return (this & ~flag);
    }

    public bool is_set (Dcs.UI.AxisFlag flag) {
        return (flag in this);
    }
}
...
public class Dcs.UI.Axis : Dcs.UI.Canvas, Dcs.Buildable, Dcs.Object {
    ...
    public Dcs.UI.AxisFlag flags { get; set; }

    public bool show_label { get; set; default = true; }

    /* Orientation of the axis */
    public Dcs.UI.Orientation orientation { get; set; default = Dcs.UI.Orientation.HORIZONTAL; }
    ...
    public signal void orientation_changed (Dcs.UI.Orientation orientation);
    ...
    construct {
        ...
        flags = Dcs.UI.AxisFlag.DRAW_LABEL |
                Dcs.UI.AxisFlag.DRAW_MINOR_TICKS |
                Dcs.UI.AxisFlag.DRAW_MAJOR_TICKS |
                Dcs.UI.AxisFlag.DRAW_MINOR_LABELS |
                Dcs.UI.AxisFlag.DRAW_MAJOR_LABELS |
                Dcs.UI.AxisFlag.DRAW_START_LABEL |
                Dcs.UI.AxisFlag.DRAW_END_LABEL;
    }
                ...
                if (iter->name == "property") {
                    switch (iter->get_prop ("name")) {
                        ...
                        case "orientation":
                            ...
                            orientation = Dcs.UI.Orientation.parse (value);
                            break;
                        case "min":
                            value = iter->get_content ();
                        ...
                        case "show-label":
                            ...
                            flags = (bool.parse (value))
                                  ? flags.set (Dcs.UI.AxisFlag.DRAW_LABEL)
                                  : flags.unset (Dcs.UI.AxisFlag.DRAW_LABEL);
                            break;
                        case "show-minor-ticks":
                            value = iter->get_content ();
                            flags = (bool.parse (value))
                                  ? flags.set (Dcs.UI.AxisFlag.DRAW_MINOR_TICKS)
                                  : flags.unset (Dcs.UI.AxisFlag.DRAW_MINOR_TICKS);
                            break;
                        case "show-major-ticks":
                            value = iter->get_content ();
                            flags = (bool.parse (value))
                                  ? flags.set (Dcs.UI.AxisFlag.DRAW_MAJOR_TICKS)
                                  : flags.unset (Dcs.UI.AxisFlag.DRAW_MAJOR_TICKS);
                            break;
                        case "show-minor-labels":
                            value = iter->get_content ();
                            flags = (bool.parse (value))
                                  ? flags.set (Dcs.UI.AxisFlag.DRAW_MINOR_LABELS)
                                  : flags.unset (Dcs.UI.AxisFlag.DRAW_MINOR_LABELS);
                            break;
                        case "show-major-labels":
                            value = iter->get_content ();
                            flags = (bool.parse (value))
                                  ? flags.set (Dcs.UI.AxisFlag.DRAW_MAJOR_LABELS)
                                  : flags.unset (Dcs.UI.AxisFlag.DRAW_MAJOR_LABELS);
                            break;
                        case "show-start-label":
                            value = iter->get_content ();
                            flags = (bool.parse (value))
                                  ? flags.set (Dcs.UI.AxisFlag.DRAW_START_LABEL)
                                  : flags.unset (Dcs.UI.AxisFlag.DRAW_START_LABEL);
                            break;
                        case "show-end-label":
                            value = iter->get_content ();
                            flags = (bool.parse (value))
                                  ? flags.set (Dcs.UI.AxisFlag.DRAW_END_LABEL)
                                  : flags.unset (Dcs.UI.AxisFlag.DRAW_END_LABEL);
                            break;
                        case "rotate-label":
                            ...
                            message ("%s", value);
                            flags = (bool.parse (value))
                                  ? flags.set (Dcs.UI.AxisFlag.ROTATE_LABEL)
                                  : flags.unset (Dcs.UI.AxisFlag.ROTATE_LABEL);
                            if (this != null)
                    ...
                    switch (iter->get_prop ("name")) {
                        ...
                        case "show-label":
                            iter->set_content ("%s".printf (flags.is_set (
                                      Dcs.UI.AxisFlag.DRAW_LABEL).to_string ()));
                            break;
                        case "show-minor-ticks":
                            iter->set_content ("%s".printf (flags.is_set (
                                Dcs.UI.AxisFlag.DRAW_MINOR_TICKS).to_string ()));
                            break;
                        case "show-major-ticks":
                            iter->set_content ("%s".printf (flags.is_set (
                                Dcs.UI.AxisFlag.DRAW_MAJOR_TICKS).to_string ()));
                            break;
                        case "show-minor-labels":
                            iter->set_content ("%s".printf (flags.is_set (
                               Dcs.UI.AxisFlag.DRAW_MINOR_LABELS).to_string ()));
                            break;
                        case "show-major-labels":
                            iter->set_content ("%s".printf (flags.is_set (
                               Dcs.UI.AxisFlag.DRAW_MAJOR_LABELS).to_string ()));
                            break;
                        case "show-start-label":
                            iter->set_content ("%s".printf (flags.is_set (
                                Dcs.UI.AxisFlag.DRAW_START_LABEL).to_string ()));
                            break;
                        case "show-end-label":
                            iter->set_content ("%s".printf (flags.is_set (
                                  Dcs.UI.AxisFlag.DRAW_END_LABEL).to_string ()));
                            break;
                        case "rotate-label":
                            iter->set_content ("%s".printf (flags.is_set (
                                    Dcs.UI.AxisFlag.ROTATE_LABEL).to_string ()));
                            break;
                        default:
                            break;
                    }
    ...
    public override bool draw (Cairo.Context cr) {
        ...
        for (var i = 0; i <= div_major; i++) {
            string tick_label;
            if (this.flags.is_set (Dcs.UI.AxisFlag.REVERSE_ORDER)) {
            ...
            if (flags.is_set (Dcs.UI.AxisFlag.ROTATE_LABEL)) {
        ...
        if (orientation == Dcs.UI.Orientation.HORIZONTAL) {
            for (var i = 0; i <= div_major; i++) {
                x = i * w / div_major;
                ...
                if (this.flags.is_set (Dcs.UI.AxisFlag.DRAW_MAJOR_TICKS)) {
                    cr.move_to (x, y);
                ...
                /* Draw label */
                if (((i != 0) && (i != div_major) && flags.is_set (Dcs.UI.AxisFlag.DRAW_MAJOR_LABELS)) ||
                    (flags.is_set (Dcs.UI.AxisFlag.DRAW_START_LABEL) && (i == 0)) ||
                    (flags.is_set (Dcs.UI.AxisFlag.DRAW_END_LABEL) && (i == div_major))) {
            ...
            /* Draw minor ticks */
            if (this.flags.is_set (Dcs.UI.AxisFlag.DRAW_MINOR_TICKS)) {
        ...
        } else if (orientation == Dcs.UI.Orientation.VERTICAL) {
 ...
 *        var h = get_allocated_height ();
 *
 *        var pos = (orientation == Dcs.UI.Orientation.HORIZONTAL)
 *                    ? (event.x - (w / 2)) >= 0
 *                    : (event.y - (h / 2)) >= 0;
 *
