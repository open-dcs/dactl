protected class Dcs.UI.ColorMap : Dcs.UI.Canvas, Dcs.Buildable, Dcs.Object {
     ...
     */
    private Dcs.UI.ColorGradientType _gradient;
    public Dcs.UI.ColorGradientType gradient {
                ...
                if (iter->name == "property") {
                    switch (iter->get_prop ("name")) {
                        ...
                        case "gradient":
                            ...
                            gradient = Dcs.UI.ColorGradientType.parse (g);
                            break;
                        default:
                            break;
                    }
    ...
    public override bool draw (Cairo.Context cr) {
        ...
        for (int i = 0; i < h; i++) {
            ...
            switch (gradient) {
                case Dcs.UI.ColorGradientType.RGB:
                    color = Dcs.UI.rgb_lerp (value, min_color, 0, max_color, 1);
                    break;
                case Dcs.UI.ColorGradientType.HSV:
                    color = Dcs.UI.hsv_lerp (value, min_color, 0, max_color, 1);
                    break;
                default:
                    break;
            }
