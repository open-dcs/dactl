[Flags]
public enum Dcs.UI.GridFlag {
    DRAW_BORDER     = 0x01;

    public Dcs.UI.GridFlag set (Dcs.UI.GridFlag flag) {
        return (this | flag);
    }

    public Dcs.UI.GridFlag unset (Dcs.UI.GridFlag flag) {
        return (this & ~flag);
    }

    public bool is_set (Dcs.UI.GridFlag flag) {
        return (flag in this);
    }
}

//public class Dcs.UI.GridCell : GLib.Object, Dcs.Object, Dcs.Buildable {
 ...
 */
//public class Dcs.UI.GridModel : GLib.Object, Dcs.Object, Dcs.Buildable, Dcs.Container {
 ...
 */
//public class Dcs.UI.GridView : Clutter.Actor {
    ...
    //public void add_child_using_cell (Clutter.Actor child, Dcs.UI.GridCell cell) {
...
public class Dcs.UI.Grid : GLib.Object, Dcs.Object {
    ...
    //public Dcs.UI.GridModel model { get; private set; }
    //public Dcs.UI.GridView view { get; private set; }

    public Dcs.UI.GridFlag flags { get; set; }

    construct {
        flags = Dcs.UI.GridFlag.DRAW_BORDER;
    }
     ...
     */
    //public Grid () {
        //model = new Dcs.UI.GridModel ();
        //view = new Dcs.UI.GridView.with_model (model);
    //}

    /**
     * Construction using a data model.
     */
    //public Grid.with_model (Dcs.UI.GridModel model) {
        //this.model = model;
        //view = new Dcs.UI.GridView.with_model (model);
    //}
    ...
    //public void add_children () {
        //var cells = model.get_children (typeof (Dcs.UI.ChannelTreeView));
        //foreach (var cell in cells.values) {
            ...
            //view.add_child_using_cell (cell_actor, cell as Dcs.UI.GridCell);
        //}
    //}
}
