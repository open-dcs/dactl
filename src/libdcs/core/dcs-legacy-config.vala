...
public class Dcs.LegacyConfig : GLib.Object {
    ...
    private void load_document () throws Dcs.ConfigError {
        ...
        ctx->register_ns ("ui", "urn:libdcs-ui");
    ...
    public Xml.Node * get_xml_node (string xpath) throws Dcs.ConfigError {
    ...
    public Xml.XPath.NodeSet * get_xml_nodeset (string xpath) throws Dcs.ConfigError {
        obj = ctx->eval_expression (xpath);
        if (obj == null) {
            throw new Dcs.ConfigError.INVALID_XPATH_EXPR (
                "The XPath expression %s is invalid.", xpath
     ...
     */
    public void print_xml_node (string xpath) throws Dcs.ConfigError {
        obj = ctx->eval_expression (xpath);
        if (obj == null) {
            throw new Dcs.ConfigError.INVALID_XPATH_EXPR (
                "The XPath expression %s is invalid.", xpath
    ...
    public bool get_boolean_property (string property) {
        string xpath = "//dcs/property[@name=\"%s\"]".printf (property);
        Xml.Node *node;
