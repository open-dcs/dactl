[GtkTemplate (ui = "/org/opendcs/dcs/ui/widget-settings.ui")]
private class Dcsg.WidgetSettings : Gtk.Box {
    ...
    private Dcs.UI.CompositeWidget widget;
    ...
    public WidgetSettings (Dcs.UI.CompositeWidget widget) {
        this.widget = widget;
