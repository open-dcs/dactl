[GtkTemplate (ui = "/org/opendcs/dcs/ui/settings-sidebar.ui")]
private class Dcsg.SettingsSidebar : Gtk.Box {
    ...
    private void populate () {
        /*
         *foreach (var page in Dcsg.SettingsStackPage.all ()) {
    ...
    private void row_activated_cb (Gtk.TreeView treeview, Gtk.TreePath path, Gtk.TreeViewColumn column) {
        ...
        //selection_action.activate ((Dcsg.SettingsStackPage) listmodel.get_path (iter).get_indices ()[0]);
    }
}
