[GtkTemplate (ui = "/org/opendcs/dcs/ui/settings-treeview.ui")]
public abstract class Dcsg.SettingsTreeView : Gtk.TreeView {
...
public class Dcsg.CldSettingsTreeView : Dcsg.SettingsTreeView {
    public enum Columns {
        TYPE,
        ID,
        URI
        ...
        if (object is Cld.Container) {
            foreach (var obj in (object as Cld.Container).get_objects ().values) {
                /** XXX TBD - This will require some restructuring of the
                  ...
                  *
                  *var admin = Dcsg.Application.get_default ().model.admin;
...
public class Dcsg.NativeSettingsTreeView : Dcsg.SettingsTreeView {
    public enum Columns {
        TYPE,
        ID,
        OBJECT
    ...
    /* Emits a signal containing the unique idetifier of the selected row */
    public signal void select (Dcs.Object object);
    ...
    public void generate (Gee.Map<string, Dcs.Object> map, int d) {
        foreach (var object in map.values)
            generate_from_object (object, d);
    }

    public void generate_from_object (Dcs.Object object, int d) {
        GLib.Type type = object.get_type ();
        GLib.ObjectClass ocl = (ObjectClass)type.class_ref ();
        void* o = object;
    ...
    public override void cursor_changed_cb () {
        ...
        if (path != null) {
            ...
            debug ("object id: %s", (object as Dcs.Object).id);
            select (object as Dcs.Object);
        }
    }
}
