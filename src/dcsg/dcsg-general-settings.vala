[GtkTemplate (ui = "/org/opendcs/dcs/ui/general-settings.ui")]
public class Dcsg.GeneralSettings : Gtk.Box {
    ...
    construct {
        ...
        foreach (var page in pages.values) {
            comboboxtext_startup_page.append (page.id, (page as Dcs.UI.Page).title);
        }
