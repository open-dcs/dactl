 ...
 * libpeas.
 *
 * A minimal file for the plugin libdcs-sompelugin.so looks like this:
 *
 * [Plugin]
 ...
 */
public class Dcs.PluginInformation : GLib.Object {
    ...
    /**
     * Factory method to create a #DcsPluginInformation from #GFile.
     *
     * @param file a #GFile pointing to the sidecar file
     * @return A new instance of #DcsPluginInformation
     */
