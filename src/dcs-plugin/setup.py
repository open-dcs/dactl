...
d = setup(
    ...
    description = ("Utility to simplify the creation of new plugins for DCS."),
    long_description = read('README.md'),

    url = "http://packages.python.org/geoffjay/dcs-plugin",
    license = "MIT",
    ...
    entry_points = {
        'console_scripts': [
            'dcs-plugin = dcs_plugin.__main__:main'
        ]
    },
