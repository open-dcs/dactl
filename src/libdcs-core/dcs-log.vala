...
public enum Dcs.LogLevel {
    LEVEL_TRACE = LogLevelFlags.LEVEL_DEBUG + 1;
}

public class Dcs.SysLog : GLib.Object {

    public static int verbosity { get; set; default = 0; }

    private static Once<Dcs.SysLog> _instance;
    ...
    private static string level_str (LogLevelFlags log_level) {
        switch ((ulong) log_level & LogLevelFlags.LEVEL_MASK) {
            ...
            case Dcs.LogLevel.LEVEL_TRACE:   return "   TRACE";
    ...
    private static string level_str_with_color (LogLevelFlags log_level) {
        switch ((ulong) log_level & LogLevelFlags.LEVEL_MASK) {
            ...
            case Dcs.LogLevel.LEVEL_TRACE:   return "   \033[1;36mTRACE\033[0m";
     ...
     */
    public static unowned Dcs.SysLog get_default () {
        return _instance.once (() => { return new Dcs.SysLog (); });
    }
