internal class Dcs.Recorder.Main : GLib.Object {
    ...
    public void exit (int exit_code) {
        ...
        Dcs.SysLog.shutdown ();
        (app as Dcs.Recorder.Server).shutdown ();
    }
    ...
    private int run (string[] args) {
        message ("Recorder Server v%s starting...", Dcs.VERSION);
        app.launch (args);
    ...
    private static int main (string[] args) {
        ...
        Dcs.Recorder.Main main = null;
        Dcs.Recorder.DBusService service = null;
        ...
        try {
            ...
            main = new Dcs.Recorder.Main ();
            service = new Dcs.Recorder.DBusService (main);
            service.publish ();
        } catch (GLib.Error e) {
            error ("%s", e.message);
        }
